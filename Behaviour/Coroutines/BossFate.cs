...
namespace Tarot.Behaviour.Coroutines
{
    ...
    internal sealed class BossFate
    {
        private static readonly object SyncRootObject = new object();

        private static volatile BossFate instance;

        private BossFate() {}

        public static BossFate Instance
        {
            get
            {
                if (instance == null)
        ...
        {
            this.Coroutine = new ActionRunCoroutine(coroutine => BossFateTask());
        }
    }
}