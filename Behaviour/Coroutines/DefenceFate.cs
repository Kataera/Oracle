...
namespace Tarot.Behaviour.Coroutines
{
    ...
    internal sealed class DefenceFate
    {
        private static readonly object SyncRootObject = new object();

        private static volatile DefenceFate instance;

        private DefenceFate() {}

        public static DefenceFate Instance
        {
            get
            {
                if (instance == null)
        ...
        private static async Task<bool> DefenceFateTask()
        {
        ...
        {
            this.Coroutine = new ActionRunCoroutine(coroutine => DefenceFateTask());
        }
    }
}