...
namespace Tarot.Behaviour.Coroutines
{
    ...
    internal sealed class EscortFate
    {
        private static readonly object SyncRootObject = new object();

        private static volatile EscortFate instance;

        private EscortFate() {}

        public static EscortFate Instance
        {
            get
            {
                if (instance == null)
        ...
        {
            this.Coroutine = new ActionRunCoroutine(coroutine => EscortFateTask());
        }
    }
}