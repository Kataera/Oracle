    ...
    internal static class SelectPoiType
    {
        ...
        private static Composite CreateBehaviour()
        {
            ...
            Composite[] composites =
            {
                ...
                new HookExecutor("SetCombatPoi", "A hook to help defend the character when they're under attack.", setCombatPoi),
                new HookExecutor("SetFatePoi", "A hook that selects a viable FATE and assigns it as the Poi.", setFatePoi),
                new HookExecutor("SetWaitPoi", "A hook that sets the correct idle Poi based on user settings.", setWaitPoi)
            };
