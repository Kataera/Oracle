    ...
    public class MaterialForm : Form, IMaterialControl
    {
        ...
        protected override CreateParams CreateParams
        {
            get
            {
                ...
                // CS_DROPSHADOW: Show a drop shadow around the form
                par.Style |= WsMinimizebox | WsSysmenu;
                ...
                if (this.headerMouseDown)
                {
                    ...
                    if (mousePoint.X < this.Width / 2)
                    {
                        this.Location = mousePoint.X < this.previousSize.Width / 2
                                            ? new Point(
                                                  Cursor.Position.X - mousePoint.X,
                                                  Cursor.Position.Y - mousePoint.Y)
                                            : new Point(
                                                  Cursor.Position.X - this.previousSize.Width / 2,
                                                  Cursor.Position.Y - mousePoint.Y);
                    }
                    else
                    {
                        this.Location = this.Width - mousePoint.X < this.previousSize.Width / 2
                                            ? new Point(
                                                  Cursor.Position.X - this.previousSize.Width + this.Width
                                                  - mousePoint.X,
                                                  Cursor.Position.Y - mousePoint.Y)
                                            : new Point(
                                                  Cursor.Position.X - this.previousSize.Width / 2,
        ...
        protected override void OnResize(EventArgs e)
        {
            ...
            this.minButtonBounds =
                new Rectangle(
                    this.Width - this.SkinManager.FormPadding / 2 - 3 * StatusBarButtonWidth,
                    0,
                    StatusBarButtonWidth,
                    StatusBarHeight);
            this.maxButtonBounds =
                new Rectangle(
                    this.Width - this.SkinManager.FormPadding / 2 - 2 * StatusBarButtonWidth,
                    0,
                    StatusBarButtonWidth,
                    StatusBarHeight);
            this.xButtonBounds = new Rectangle(
                this.Width - this.SkinManager.FormPadding / 2 - StatusBarButtonWidth,
                0,
                StatusBarButtonWidth,
                StatusBarHeight);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using (var borderPen = new Pen(this.SkinManager.GetDividersColor(), 1))
            {
                ...
                g.DrawLine(
                    borderPen,
                    new Point(this.Width - 1, this.actionBarBounds.Bottom),
            ...
            using (var formButtonsPen = new Pen(this.SkinManager.ActionBarTextSecondary, 2))
            {
                ...
                if (showMax)
                {
                    g.DrawRectangle(
                        formButtonsPen,
                        this.maxButtonBounds.X + (int) (this.maxButtonBounds.Width * 0.33),
