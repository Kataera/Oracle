...
namespace Tarot.Forms.MaterialSkin.Controls
{
    public class MaterialForm : Form, IMaterialControl
    {
        ...
        protected override void OnResize(EventArgs e)
        {
            ...
            minButtonBounds = new Rectangle((Width - this.SkinManager.FormPadding / 2) - 3 * STATUS_BAR_BUTTON_WIDTH, 0, STATUS_BAR_BUTTON_WIDTH, STATUS_BAR_HEIGHT);
            maxButtonBounds = new Rectangle((Width - this.SkinManager.FormPadding / 2) - 2 * STATUS_BAR_BUTTON_WIDTH, 0, STATUS_BAR_BUTTON_WIDTH, STATUS_BAR_HEIGHT);
            xButtonBounds = new Rectangle((Width - this.SkinManager.FormPadding / 2) - STATUS_BAR_BUTTON_WIDTH, 0, STATUS_BAR_BUTTON_WIDTH, STATUS_BAR_HEIGHT);
